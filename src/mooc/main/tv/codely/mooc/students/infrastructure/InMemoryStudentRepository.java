...
public final class InMemoryStudentRepository implements StudentRepository {
    ...
    public List<Student> searchAll() {
        return Arrays.asList(
            new Student(new StudentId(generator.generate()), "name", "surname", "email@gmail.com"),
            new Student(new StudentId(generator.generate()), "Other name", "Other surname", "another@gmail.com")
        );
    }
}
